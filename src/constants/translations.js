export const translations = {
  ...
  FR: {
    ...
    footer: {
      ...
      contact: 'Contact',
      phone: '+375 29 798 45 02',
      rights: 'Tous droits réservés. © 2026 Café VAFFEL'
    },
    comments: {
      title: 'AVIS',
      nameLabel: 'Votre nom',
      ...
      sending: 'Envoi...',
      recentComments: 'Avis récents',
      noComments: 'Aucun avis pour le moment. Soyez le premier!',
      delete: 'Supprimer',
      adminBadge: 'ADMIN',
  ...
  EN: {
    ...
    footer: {
      ...
      contact: 'Contact',
      phone: '+375 29 798 45 02',
      rights: 'All rights reserved. 2026 VAFFEL Cafe'
    },
    comments: {
      title: 'REVIEWS',
      nameLabel: 'Your name',
