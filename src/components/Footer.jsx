      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-center items-center gap-4 md:gap-8 text-center">
          ...
          <div className="flex-shrink-0">
            <div className="flex justify-center mb-1 md:mb-2">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 12.071a8 8 0 111.314 4.586 4.586 4.586 0 011.657-4.586 4.586-4.586 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 1.657 1.657 0 011.657-1.657 0z" />
              </svg>
            </div>
            <p className="text-xs md:text-sm leading-relaxed text-gray-100">
          ...
          <div className="flex-shrink-0">
            <div className="flex justify-center mb-1 md:mb-2">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 11-2 0 1.657 1.657 0 011.657-1.657 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 11-2 0 1.657 1.657 0 011.657-1.657 0z" />
              </svg>
            </div>
            <p className="text-xs md:text-sm leading-relaxed text-gray-100">
