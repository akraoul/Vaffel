...
const Footer = ({ translations }) => {
  ...
  return (
    <footer className="shadow-lg neon-border relative dark-mode-transition" style={{background: 'linear-gradient(to right, var(--dark-color), var(--dark-color), var(--dark-color))'}}>
