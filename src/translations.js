  ...
  RU: {
    ...
    waffles: {
      ...
      items: {
        ...
        'ЦЕЗАРЬ': {
          name: 'ЦЕЗАРЬ',
          description: 'куриная грудка, пармезан, салат айсберг, сухарики, соус «Цезарь»'
        },
        'ГРИК': {
          name: 'ГРИК',
          description: 'фета, оливки, помидоры, огурцы, красный лук, оливковое масло'
        },
        'ДЖОННИ ПЕППЕРОНИ': {
          name: 'ДЖОННИ ПЕППЕРОНИ',
          description: 'пепперони, моцарелла, томатный соус, итальянские травы'
        },
        'ЧИКЕН ЧИЗ': {
          name: 'ЧИКЕН ЧИЗ',
