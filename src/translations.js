  ...
  RU: {
    ...
    waffles: {
      ...
      items: {
        'ДЖОКЕР': {
          name: 'ДЖОКЕР',
          description: 'мармеладные мишки, клубника, воздушный рис, мусс на основе сыра «Маскарпоне» зефирный крем, сахарная пудра'
        },
        'ШТРУДЕЛЬ': {
          name: 'ШТРУДЕЛЬ',
          description: 'яблоко, корица, сыр «Маскарпоне», соус «Карманель», сахарная пудра'
        },
        'СНИКЕРС': {
          name: 'СНИКЕРС',
          description: 'шоколадно-ореховая паста, зефирный крем, дробленый арахис, соус «Карманель», воздушный рис, сахарная пудра'
        },
        'ЛЕГЕНДА НОРВЕГИИ': {
          name: 'ЛЕГЕНДА НОРВЕГИИ',
          description: 'лосось с/с, сливочный сыр, огурец, рукола'
        },
        'ЦЕЗАРЬ': {
          name: 'ЦЕЗАРЬ',
          description: 'запеченное куриное филе, томат, айсберг, соус «Цезарь»'
        },
        'ГРИК': {
          name: 'ГРИК',
          description: 'томат, огурец, паприка, оливки, соус «Сладкая аджика», соус «Фета»'
        },
        'ДЖОННИ ПЕППЕРОНИ': {
          name: 'ДЖОННИ ПЕППЕРОНИ',
          description: 'пепперони, жареный бекон, томатный соус, паприка, айсберг, соус «Фета»'
        },
        'ЧИКЕН ЧИЗ': {
          name: 'ЧИКЕН ЧИЗ',
